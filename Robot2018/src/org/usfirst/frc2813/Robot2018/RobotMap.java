...
public class RobotMap {
	...
	public static void init() {
        ...
        new VictorSPX(2).set(ControlMode.Follower, driveTrainSpeedController1.getDeviceID());
        new VictorSPX(8).set(ControlMode.Follower, driveTrainSpeedController2.getDeviceID());
        ...
        armSpeedController1 = new WPI_VictorSPX(7);
