...
import org.usfirst.frc2813.Robot2018.commands.drivetrain.AutoCurveDriveCommand;
import org.usfirst.frc2813.Robot2018.commands.drivetrain.QuickTurnCommand;
import org.usfirst.frc2813.Robot2018.commands.drivetrain.ResetDriveTrainEncodersCommand;
import org.usfirst.frc2813.Robot2018.commands.drivetrain.ResetDriveTrainGyroCommand;
...
public class AutonomousCommandGroup extends CommandGroup {
	...
	*/
	...
	public void addDriveTrainSensorResetSequenceSync() {
		addSequential(new ResetDriveTrainEncodersCommand());
		addSequential(new ResetDriveTrainGyroCommand());
	}
	/**
	...
	private void curve(Direction direction, double angle, double radius, boolean clockwise) {
		...
		addSequential(new AutoCurveDriveCommand(speed, angle, radius));		
	}
	/**
