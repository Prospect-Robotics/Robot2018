	...
	*/
    ...
    public void robotInit() {
       ...
       // camera.setResolution(640, 480);'
		...
		RobotMap.srxElevator.configSelectedFeedbackSensor(FeedbackDevice.CTRE_MagEncoder_Relative, Constants.kPIDLoopIdx,
		 ...
		 * units per rotation.
		 */
		RobotMap.srxElevator.configAllowableClosedloopError(0, Constants.kPIDLoopIdx, Constants.kTimeoutMs);

		/* set closed loop gains in slot0, typically kF stays zero. */
		RobotMap.srxElevator.config_kF(Constants.kPIDLoopIdx, 0.0, Constants.kTimeoutMs);
