...
public class Robot extends TimedRobot {
    ...
    SendableChooser<Integer> selectAuto;
    ...
    public void robotInit() {
        ...
        oi = new OI();
        selectAuto = new SendableChooser<Integer>();
        selectAuto.addDefault("LEFT", LEFT);
        selectAuto.addObject("CENTER", CENTER);
        selectAuto.addObject("RIGHT", RIGHT);
        // Add commands to Autonomous Sendable Chooser
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        
        
        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        SmartDashboard.putData("Choose Auto Mode", selectAuto);
