...
public final class MotorStateFactory {
	...
	public static IMotorState createMaintainTargetOutputCurrent(IMotor motor, Direction targetDirection, Double targetOutputCurrent) {
		return new MaintainTargetOutputCurrent(motor, targetDirection, targetOutputCurrent);
	}
}
