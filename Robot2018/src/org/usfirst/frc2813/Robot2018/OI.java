...
public class OI {
    ...
    public JoystickButton spin4Motors;
    public JoystickButton spin4MotorsBackwards;
    ...
    public OI() {
        ...
        spin4MotorsBackwards = new JoystickButton(buttonPanel, 5);
        spin4MotorsBackwards.whileHeld(new MoveElevator(false));
        spin4Motors = new JoystickButton(buttonPanel, 4);
        spin4Motors.whileHeld(new MoveElevator(true));
