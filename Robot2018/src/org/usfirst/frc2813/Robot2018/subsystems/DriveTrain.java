...
public class DriveTrain extends Subsystem {
	...
	public void arcadeDrive(Joystick joystick1, Joystick joystickIgnored) {// currently not used
		double z = joystick1.getX() + joystick1.getTwist();
		double x = joystick1.getY();
		robotDrive.arcadeDrive(-joystick1.getX(), -joystick1.getY(), false);
	}


	public void arcadeDrive(double x, double y, double rotate) {// used in AutoDrive bc there is no reason to change to
																// tankDrive
		double z = x + rotate;
		robotDrive.arcadeDrive((y > 0 ? y * y : -y * y), z * z * z, false);// TODO check math
	}
