...
public class DriveTrain extends Subsystem {
	...
	// RobotMap.driveTrainQuadratureEncoder3;
	...
	public void arcadeDrive(Joystick joystick1) {//currently not used
	...
	public void arcadeDrive(double x, double y, double rotate) {//used in AutoDrive bc there is no reason to change to tankDrive
		double z = x + rotate;
