 ...
 */
public class RateUOM extends UOM {
	// Metric System
	public static   final  RateUOM MillimetersPerMillisecond = new RateUOM(LengthUOM.Millimeters, TimeUOM.Milliseconds);
	...
	/* Get the canonical unit of measure for rate */
	public RateUOM getCanonicalUOM() {
		return CanonicalUOM;
	}
	
	/* Get the distance unit of measure */
